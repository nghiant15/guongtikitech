...
const Item = require("../../models/AdminApp/ItemModel");
...
router.get("/suggest", async (req, res) => {
  try {
    const { page = 1, limit = 100, sdk_type, companyid } = req.query
    let opts = sdk_type ? {
      level: sdk_type
    } : {};
    if (req.query.level) {
    ...
    //opts["companyid"] = companyid == undefined || companyid == null || companyid == "null" ? "" : companyid
