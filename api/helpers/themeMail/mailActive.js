                            ...
                            <div class="column"
                                ...
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    ...
                                    <p style="Margin-top: 20px;Margin-bottom: 20px;font-family: arial,sans-serif;"><span
                                        class="font-arial">Cám ơn ${username} đã tham gia. Để kích hoạt tài khoản vui lòng nhấn vào nút
                                        bên dưới hoặc sử dụng mã bên dưới để kích hoạt.</span></p>
                                </div>
                                </div>
